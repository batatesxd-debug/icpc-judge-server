...
app.post("/judgeSubmission", async (req, res) => {
  ...
  // تم إلغاء الـ write هنا — الكلاينت (contest.js) بيحفظ الـ submission بعد ما
  // يستقبل الـ verdict من السيرفر، وبيضيف بيانات أكمل (teamId, displayName, language).
  // الـ double-write كانت بتخلي كل submission تتحسب مرتين في الـ standings وتضاعف الـ penalty.
